...
namespace GA.Migrations
{
    ...
    [Migration("20260814111031_AddEdasCompanies")]
    partial class AddEdasCompanies
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GA.Core.Domain.Entities.AppNotification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("GA.Core.Domain.Entities.ChatMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("GA.Core.Domain.Entities.ChatReadState", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("GA.Core.Domain.Entities.Conversation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("FieldWorkerUserId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "FieldWorkerUserId")
                        .IsUnique()
            ...
            modelBuilder.Entity("GA.Core.Domain.Entities.District", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("GA.Core.Domain.Entities.EdasCompany", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("EdasCompanies", (string)null);
                });
            ...
            modelBuilder.Entity("GA.Core.Domain.Entities.OfficeDirectConversation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("MigratedFromConversationId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "UserOneId", "UserTwoId")
                        .IsUnique()
                        .HasDatabaseName("IX_OfficeDirectConversations_Tenant_UserPair");

                    b.ToTable("OfficeDirectConversations");
                });

            modelBuilder.Entity("GA.Core.Domain.Entities.OfficeDirectMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("LegacyChatMessageId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("OfficeDirectConversationId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("OfficeDirectConversationId");

                    b.HasIndex("OfficeDirectConversationId", "SenderUserId", "ClientMessageId");

                    b.ToTable("OfficeDirectMessages");
                });

            modelBuilder.Entity("GA.Core.Domain.Entities.OfficeDirectReadState", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("OfficeDirectConversationId", "UserId")
                        .IsUnique()
                        .HasDatabaseName("IX_OfficeDirectReadStates_Conversation_User");

                    b.ToTable("OfficeDirectReadStates");
                });
            ...
            modelBuilder.Entity("GA.Core.Domain.Entities.Photo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("GA.Core.Domain.Entities.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("GA.Core.Domain.Entities.UserPushToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("GA.Core.Domain.Entities.UserWebPushSubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("UserWebPushSubscriptions");
                });
            ...
            modelBuilder.Entity("GA.Core.Domain.Entities.ChatMessage", b =>
                {
                    b.HasOne("GA.Core.Domain.Entities.Conversation", "Conversation")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("GA.Core.Domain.Entities.District", b =>
                {
                    b.HasOne("GA.Core.Domain.Entities.City", "City")
                        .WithMany("Districts")
            ...
            modelBuilder.Entity("GA.Core.Domain.Entities.OfficeDirectMessage", b =>
                {
                    b.HasOne("GA.Core.Domain.Entities.OfficeDirectConversation", "Conversation")
                        .WithMany("Messages")
                        .HasForeignKey("OfficeDirectConversationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

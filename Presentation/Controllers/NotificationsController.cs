...

    {
...

        {
...

            {
                ...
                if (string.IsNullOrWhiteSpace(type))
                    ...
                    query = query.Where(n =>
                        ...
                        n.Type == "WorkOrderAssigned"

                        || n.Type == "WorkOrderCreated"

                        || n.Type == "WorkOrderPeriodic");
...

            {
                ...
                // Mobil / kişisel zil: yalnızca bu kullanıcıya hedeflenen bildirimler
...

            {
                ...
                unreadQuery = unreadQuery.Where(n =>

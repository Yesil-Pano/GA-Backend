    ...
    public class ReportsController : ControllerBase
    {
            ...
            [FromQuery] int pageSize = 50)
        {
            ...
            var items = rawItems.Select(w => new
            {
                ...
                w.mobileDescription,
                w.address,
                startDate = TurkeyTime.FormatApi(w.startDate),
                endDate = TurkeyTime.FormatApi(w.endDate),
                startedAt = TurkeyTime.FormatApi(w.startedAt),
                completedAt = TurkeyTime.FormatApi(w.completedAt),
                cancelledAt = TurkeyTime.FormatApi(w.cancelledAt),
